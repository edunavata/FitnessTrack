...
Revision ID: a127e137cccd
Revises:
Create Date: 2025-10-07 02:06:08.190742
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "difficulty",
            sa.Enum("BEGINNER", "INTERMEDIATE", "ADVANCED", name="level"),
        ...
        sa.CheckConstraint(
            "length(slug) > 0", name=op.f("ck_exercises_ck_exercises_slug_not_empty")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["exercise_id"],
            ["exercises.id"],
            name=op.f("fk_exercise_tags_exercise_id_exercises"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["tag_id"], ["tags.id"], name=op.f("fk_exercise_tags_tag_id_tags"), ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_subjects_user_id_users"), ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["subject_id"],
            ["subjects.id"],
            name=op.f("fk_subject_body_metrics_subject_id_subjects"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["subject_id"],
            ["subjects.id"],
            name=op.f("fk_subject_profiles_subject_id_subjects"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["routine_id"],
            ["routines.id"],
            name=op.f("fk_cycles_routine_id_routines"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["subject_id"],
            ["subjects.id"],
            name=op.f("fk_cycles_subject_id_subjects"),
            ondelete="CASCADE",
        ),
    ...
    with op.batch_alter_table("cycles", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_cycles_subject_started_on", ["subject_id", "started_on"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["routine_id"],
            ["routines.id"],
            name=op.f("fk_routine_days_routine_id_routines"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["exercise_id"],
            ["exercises.id"],
            name=op.f("fk_routine_day_exercises_exercise_id_exercises"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["routine_day_id"],
            ["routine_days.id"],
            name=op.f("fk_routine_day_exercises_routine_day_id_routine_days"),
            ondelete="CASCADE",
        ),
    ...
    with op.batch_alter_table("routine_day_exercises", schema=None) as batch_op:
        batch_op.create_index(
            "ix_rde_day_exercise", ["routine_day_id", "exercise_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["cycle_id"], ["cycles.id"], name="fk_ws_cycle_id", ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["routine_day_id"],
            ["routine_days.id"],
            name=op.f("fk_workout_sessions_routine_day_id_routine_days"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["subject_id"],
            ["subjects.id"],
            name=op.f("fk_workout_sessions_subject_id_subjects"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["routine_day_exercises.id"],
            name=op.f("fk_routine_exercise_sets_routine_day_exercise_id_routine_day_exercises"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["exercise_id"],
            ["exercises.id"],
            name=op.f("fk_exercise_set_logs_exercise_id_exercises"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["planned_set_id"],
            ["routine_exercise_sets.id"],
            name=op.f("fk_exercise_set_logs_planned_set_id_routine_exercise_sets"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["session_id"],
            ["workout_sessions.id"],
            name=op.f("fk_exercise_set_logs_session_id_workout_sessions"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["subject_id"],
            ["subjects.id"],
            name=op.f("fk_exercise_set_logs_subject_id_subjects"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_exercise_set_logs")),
        sa.UniqueConstraint(
            "subject_id", "exercise_id", "performed_at", "set_index", name="uq_esl_session_set"
        ),
    )
    with op.batch_alter_table("exercise_set_logs", schema=None) as batch_op:
        batch_op.create_index(
            "ix_esl_by_session",
            ["subject_id", "exercise_id", "session_id", "set_index"],
            unique=False,
        )
